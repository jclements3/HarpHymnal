 ...
 * the home grid is open.
 *
 * The user grants "always open with HarpHymnal" the first time, after
 * which Android routes future USB-MIDI attachments here automatically.
 */
